...
- [appendJsonReport](#fn-appendjsonreport)

## Types

- [Counts](#type-counts)
- [BenchStatus](#type-benchstatus)
- [BenchmarkReport](#type-benchmarkreport)
...
<a id="type-benchstatus"></a>

## BenchStatus

```zig
pub const BenchStatus = enum {
    benchmarked,
    skipped,
    failed,
    timed_out,
...
| --- | --- | --- | --- |
| [jsonStringify](#fn-benchmarkreport-jsonstringify) | `self: BenchmarkReport, json: *std.json.Stringify` | `!void` |  |
| [deinit](#fn-benchmarkreport-deinit) | `self: *BenchmarkReport, allocator: std.mem.Allocator` | `void` |  |

<a id="fn-benchmarkreport-jsonstringify"></a>

### BenchmarkReport.jsonStringify

```zig
pub fn jsonStringify(self: BenchmarkReport, json: *std.json.Stringify) !void
```

References: [`BenchmarkReport`](#type-benchmarkreport)

<a id="fn-benchmarkreport-deinit"></a>

### BenchmarkReport.deinit
...
References: [`BenchmarkReport`](#type-benchmarkreport), [`Counts`](#type-counts)
