...
References: [`api.Snapshot`](api.md#type-snapshot)

<a id="alias-userdatasnapshothooks"></a>
...
References: [`api.UserdataSnapshotHooks`](api.md#fn-userdatasnapshothooks)
